...
class App extends Component {
	constructor(props) {
		...
		this.state = {
			data: [
				{name: 'Andy R.', salary: 900, increase: false, rise: true, id: 1},
				{name: 'Lex D.', salary: 1200, increase: true, rise: false, id: 2},
				{name: 'Max M.', salary: 1500, increase: false, rise: false, id: 3},
			],
			term: '',
			filter: 'all'
		}
